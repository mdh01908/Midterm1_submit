...
hist(dat$Age, main = "Histogram of Age", xlab = "Age in Years", ylab = "Counts", col="lightblue")
...
ggplot(data = dat, aes(x = Gender_Label)) +
  geom_bar(fill="purple")+
  theme_minimal()+
  xlab("Gender")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by Gender") 

ggplot(data = dat, aes(x = State)) +
  geom_bar(fill="green")+
  theme_minimal()+
  xlab("State")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by State") 

ggplot(data = dat, aes(x = interest_Label)) +
  geom_bar(fill="pink")+
  theme_minimal()+
  xlab("Interest Level")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by Interest Level") 

ggplot(data = dat, aes(x = EmpStat_Label)) +
...
ggplot(data = dat, aes(x = total_race_Label)) +
...
ggplot(data = dat, aes(x = EnglishProf_Label)) +
  geom_bar(fill="darkseagreen")+
  theme_minimal()+
  xlab("English Proficiency")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by English Proficiency") 

ggplot(data = dat, aes(x = HelpMedLit_Label)) +
  geom_bar(fill="blue")+
  theme_minimal()+
  xlab("Help with Medical Literature")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by Medical Literacy") 

ggplot(data = dat, aes(x = Location_Label)) +
  geom_bar(fill="darkred")+
  theme_minimal()+
  xlab("Location")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by Location") 

ggplot(data = dat, aes(x = Insurance_Label)) +
  geom_bar(fill="slateblue1")+
  theme_minimal()+
  xlab("Insurance")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by Insurance") 

ggplot(data = dat, aes(x = AffordMed_Label)) +
  geom_bar(fill="purple")+
  theme_minimal()+
  xlab("Ability to Afford Medical Care")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by Ability to Afford Medical Care") 

ggplot(data = dat, aes(x = Benefit_Label)) +
  geom_bar(fill="turquoise")+
  theme_minimal()+
  xlab("Benefit")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by Perceived Benefit") 

ggplot(data = dat, aes(x = Risk_Label)) +
  geom_bar(fill="lavender")+
  theme_minimal()+
  xlab("Risk")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
   labs(title = "Participant Counts by Perceived Risk") 

ggplot(data = dat, aes(x = Household)) +
  geom_bar(fill="khaki3")+
  theme_minimal()+
